...
var NativeShare = function (elementNode, config) {
    ...
    this.guide = function(){
        ...
        position.style.height = '100%';
        position.style.top = 0;
        position.style.left = 0;
        position.style.borderRadius = 0;
        position.style.backgroundColor = 'rgba(0,0,0,.8)';
    ...
    this.init = function () {
        ...
        //判断是qq内置浏览器
        isQQIn = this.isQQIn(platform_os);
        ...
        this.isloadqqApi();
        if ((isqqBrowser || isucBrowser) && !isWeixin && !isQQIn) {
            this.html();
        } else {
            this.guide();
        }
